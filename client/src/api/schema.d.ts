...
export interface components {
    schemas: {
         ...
         * @description Status of a single attribute in an IRMA session.
         *
         *     See: https://github.com/privacybydesign/irmago/blob/v0.15.2/verify.go#L30-L32
         * @enum {string}
         */
        AttributeProofStatus: "PRESENT" | "EXTRA" | "NULL";
        ...
        DisclosedAttribute: {
            /** Id */
            id: string;
            status: components["schemas"]["AttributeProofStatus"];
            /** Rawvalue */
        ...
        ExchangeResultResponse: {
            ...
            public_initiator_attribute_values: components["schemas"]["DisclosedAttribute"][];
            /** Initiator Attribute Values */
            initiator_attribute_values: components["schemas"]["DisclosedAttribute"][][];
            /**
             * Replies
             ...
             *
             */
            replies: components["schemas"]["DisclosedAttribute"][][][];
        };
        /**
        ...
        RecipientResponseResponse: {
            ...
            response_attribute_values: components["schemas"]["DisclosedAttribute"][][];
            /**
             * Recipient Secret
