...
<template>
  <div class="p-8">
    ...
    <Accordion type="single" class="w-full border-t" collapsibl>
            ...
            <div class="mt-4 flex flex-wrap gap-4">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 450 110">
                  ...
                  <path
                    d="M158.38 24.66v-6.03h-4.96v-2.5h7.97v9.64c-1.17.83-2.47 1.46-3.88 1.9-1.41.42-2.92.63-4.53.63-3.51 0-6.26-1.02-8.24-3.07-1.98-2.06-2.96-4.91-2.96-8.57 0-3.67.99-6.53 2.96-8.57 1.99-2.06 4.73-3.08 8.24-3.08 1.46 0 2.85.18 4.17.54 1.32.36 2.54.89 3.65 1.59v3.23c-1.12-.95-2.32-1.67-3.58-2.15-1.26-.48-2.59-.72-3.99-.72-2.75 0-4.81.77-6.2 2.3-1.37 1.53-2.06 3.82-2.06 6.86 0 3.03.69 5.31 2.06 6.84 1.38 1.53 3.45 2.3 6.2 2.3 1.07 0 2.03-.09 2.87-.27.86-.18 1.61-.47 2.28-.87zM166.96 5.41h14.2v2.56H170v6.65h10.69v2.56H170v8.14h11.43v2.56h-14.47V5.41zM183.34 5.41h19v2.56h-7.97v19.9h-3.05V7.97h-7.97l-.01-2.56zM215.09 5.41h3.04v22.45h-3.04V5.41zM221.06 5.41h19v2.56h-7.97v19.9h-3.05V7.97h-7.97l-.01-2.56zM261.92 7.47c-2.21 0-3.96.82-5.26 2.47-1.29 1.64-1.94 3.89-1.94 6.72 0 2.83.65 5.06 1.94 6.71 1.3 1.64 3.06 2.47 5.26 2.47 2.21 0 3.95-.82 5.23-2.47 1.29-1.64 1.94-3.88 1.94-6.71 0-2.84-.65-5.08-1.94-6.72-1.27-1.64-3.02-2.47-5.23-2.47zm0-2.46c3.15 0 5.66 1.06 7.55 3.17 1.89 2.11 2.83 4.93 2.83 8.48 0 3.54-.94 6.37-2.83 8.48-1.89 2.11-4.4 3.16-7.55 3.16-3.16 0-5.69-1.05-7.58-3.16-1.88-2.11-2.83-4.93-2.83-8.48s.94-6.38 2.83-8.48c1.9-2.12 4.42-3.17 7.58-3.17zM277.05 5.41h4.09l9.96 18.79V5.41h2.95v22.45h-4.09L280 9.08v18.79h-2.95V5.41zM141.78 106.39v-7.33l6.49-1.26V54.05l-6.49-1.26v-7.37h48.53v16.71h-9.38l-.54-7.29H160.5v16.79h21.35v9.42H160.5V97.8l6.53 1.26v7.33h-25.25zM197.89 85.03v-9.42h23.61v9.42h-23.61zM228.87 106.39v-7.33l6.57-1.38V54.22l-6.57-1.42v-7.37h26.75c5.44 0 10.24 1.28 14.4 3.85 4.16 2.54 7.4 6.07 9.71 10.59 2.34 4.49 3.52 9.66 3.52 15.49v1.13c0 5.78-1.16 10.93-3.48 15.45-2.29 4.49-5.5 8.02-9.63 10.59s-8.92 3.85-14.36 3.85l-26.91.01zm18.8-9.34h7.49c3.38 0 6.24-.88 8.58-2.64 2.34-1.79 4.13-4.23 5.36-7.33 1.26-3.1 1.88-6.63 1.88-10.59v-1.17c0-4.02-.63-7.56-1.88-10.63-1.23-3.1-3.01-5.51-5.36-7.24-2.34-1.76-5.21-2.64-8.58-2.64h-7.49v42.24zM289.79 106.39v-7.33l5.86-1.26V69.71l-6.49-1.26v-7.37h17.88l.46 5.61.08 1c1.12-2.46 2.5-4.31 4.15-5.57 1.65-1.26 3.61-1.88 5.9-1.88.73 0 1.52.07 2.39.21.87.11 1.63.27 2.3.46l-1.3 11.26-6.07-.33c-1.73-.08-3.14.21-4.23.88-1.06.67-2.01 1.63-2.85 2.89V97.8l5.86 1.26v7.33h-23.94zM346.73 107.27c-4.47 0-8.3-.98-11.51-2.93-3.21-1.95-5.67-4.66-7.37-8.12-1.7-3.49-2.55-7.49-2.55-12.02v-.88c0-4.49.85-8.47 2.55-11.93 1.7-3.49 4.15-6.21 7.33-8.16 3.21-1.98 7.03-2.97 11.47-2.97 4.49 0 8.33.99 11.51 2.97 3.18 1.95 5.62 4.66 7.33 8.12s2.55 7.45 2.55 11.97v.88c0 4.52-.85 8.53-2.55 12.02-1.7 3.46-4.15 6.17-7.33 8.12-3.18 1.95-6.99 2.93-11.43 2.93zm0-9.38c2.12 0 3.85-.57 5.19-1.72 1.34-1.14 2.33-2.74 2.97-4.77.64-2.07.96-4.47.96-7.2v-.88c0-2.68-.32-5.04-.96-7.08-.64-2.07-1.65-3.67-3.01-4.81-1.34-1.17-3.08-1.76-5.23-1.76-2.09 0-3.82.59-5.19 1.76-1.37 1.14-2.37 2.75-3.01 4.81-.61 2.04-.92 4.4-.92 7.08v.88c0 2.74.31 5.14.92 7.2.64 2.07 1.65 3.67 3.01 4.81 1.36 1.12 3.12 1.68 5.27 1.68zM373.11 106.39v-7.33l5.9-1.26V69.71l-6.53-1.26v-7.37h18.76V97.8l5.86 1.26v7.33h-23.99zm5.48-54.89V41.07h12.64V51.5h-12.64zM418.58 107.27c-3.6 0-6.7-.92-9.29-2.76-2.57-1.87-4.54-4.47-5.9-7.79-1.37-3.35-2.05-7.26-2.05-11.72v-.88c0-4.77.68-8.95 2.05-12.52 1.4-3.57 3.38-6.35 5.95-8.33 2.57-2.01 5.64-3.01 9.21-3.01 2.48 0 4.66.5 6.53 1.51 1.87.98 3.49 2.37 4.86 4.19V49.7l-6.53-1.26v-7.37h18.76V97.8l5.86 1.26v7.33h-16.45l-.92-5.53c-1.42 2.09-3.13 3.68-5.11 4.77-1.98 1.09-4.29 1.64-6.97 1.64zm3.64-9.51c1.7 0 3.2-.36 4.48-1.09 1.28-.73 2.36-1.77 3.22-3.14V74.32c-.84-1.45-1.9-2.57-3.18-3.35-1.28-.81-2.76-1.21-4.44-1.21-2.04 0-3.71.61-5.02 1.84-1.28 1.2-2.23 2.88-2.85 5.02-.59 2.15-.88 4.65-.88 7.49v.88c0 3.96.67 7.09 2.01 9.38 1.34 2.26 3.56 3.39 6.66 3.39z"
                    fill="#fff"
                  ></path>
                  <path d="m110.62 6.92-10.09 13.06" fill="#8ab000"></path>
                  <path
                    d="M100.52 26.9c-1.48 0-2.96-.47-4.22-1.44-3.02-2.34-3.58-6.68-1.25-9.7L105.14 2.7c2.34-3.02 6.68-3.58 9.7-1.25 3.02 2.34 3.58 6.68 1.25 9.7L106 24.21c-1.36 1.77-3.41 2.69-5.48 2.69z"
                    fill="#769616"
                  ></path>
                  <path
                    d="M110.57 3.94c1.08.03 1.81.45 2.33 1.07-4.81 5.72-5.63 6.63-12.2 14.78-2.42 3.13-4.94 1.51-2.52-1.62l10.1-13.07c.54-.72 1.39-1.13 2.29-1.16z"
                    fill="#fff"
                    fill-opacity=".298"
                  ></path>
                  <path
                    d="M112.92 5.04c.29.35 1.33 1.91.05 3.7L102.88 21.8c-2.42 3.13-2.73-1.45-2.73-1.45s8.87-10.72 12.77-15.31z"
                    fill="#263238"
                    fill-opacity=".2"
                  ></path>
                  <path
                    d="M111.22 4.5c1.04 0 2.28.34 1.96 1.9-.25 1.19-11.07 14.43-11.07 14.43-2.42 3.13-5.92 1.61-3.5-1.53l10.06-13c.62-.69 1.44-1.77 2.55-1.8zM8.91 6.92 19 19.98"
                    fill="#8ab000"
                  ></path>
                  <path
                    d="M19.01 26.9c-2.07 0-4.12-.92-5.48-2.69L3.43 11.15C1.1 8.13 1.65 3.78 4.68 1.44 7.7-.9 12.05-.34 14.38 2.68l10.1 13.06c2.34 3.02 1.78 7.37-1.24 9.7-1.27.99-2.75 1.46-4.23 1.46z"
                    fill="#769616"
                  ></path>
                  <path
                    d="M8.96 3.94c-1.08.03-1.81.45-2.33 1.07 4.81 5.72 5.63 6.63 12.2 14.78 2.42 3.13 4.94 1.51 2.52-1.62L11.26 5.1c-.55-.72-1.39-1.13-2.3-1.16z"
                    fill="#fff"
                    fill-opacity=".298"
                  ></path>
                  <path
                    d="M6.61 5.04c-.29.35-1.33 1.91-.05 3.7L16.65 21.8c2.42 3.13 2.73-1.45 2.73-1.45S10.51 9.63 6.61 5.04z"
                    fill="#263238"
                    fill-opacity=".2"
                  ></path>
                  <path
                    d="M8.31 4.5c-1.04 0-2.28.34-1.96 1.9.25 1.19 11.07 14.43 11.07 14.43 2.42 3.13 5.92 1.61 3.5-1.53l-10.06-13c-.61-.69-1.44-1.77-2.55-1.8z"
                    fill="#8ab000"
                  ></path>
                  <path
                    d="M21.76 15.23h76.01c3.94 0 7.13 3.19 7.13 7.13V38.8c0 3.94-3.19 7.13-7.13 7.13H21.76c-3.94 0-7.13-3.19-7.13-7.13V22.35c.01-3.93 3.2-7.12 7.13-7.12z"
                    fill="#aeea00"
                  ></path>
                  <path
                    d="M21.76 22.16h76.01c3.94 0 7.13 3.19 7.13 7.13v9.5c0 3.94-3.19 7.13-7.13 7.13H21.76c-3.94 0-7.13-3.19-7.13-7.13v-9.5c.01-3.94 3.2-7.13 7.13-7.13z"
                    fill="#263238"
                    fill-opacity=".2"
                  ></path>
                  <path
                    d="M21.76 15.23h76.01c3.94 0 7.13 3.19 7.13 7.13v9.5c0 3.94-3.19 7.13-7.13 7.13H21.76c-3.94 0-7.13-3.19-7.13-7.13v-9.5c.01-3.94 3.2-7.13 7.13-7.13z"
                    fill="#fff"
                    fill-opacity=".298"
                  ></path>
                  <path
                    d="M21.76 17.94h76.01c3.94 0 7.13 2.61 7.13 5.83v13.61c0 3.22-3.19 5.83-7.13 5.83H21.76c-3.94 0-7.13-2.61-7.13-5.83V23.77c.01-3.22 3.2-5.83 7.13-5.83z"
                    fill="#aeea00"
                  ></path>
                  <path
                    d="M21.76 48.62h76.01c3.94 0 7.13 3.19 7.13 7.13v47.13c0 3.94-3.19 7.13-7.13 7.13H21.76c-3.94 0-7.13-3.19-7.13-7.13V55.75c.01-3.94 3.2-7.13 7.13-7.13z"
                    fill="#1976d2"
                  ></path>
                  <path
                    d="M21.76 79.12h76.01c3.94 0 7.13 3.19 7.13 7.13v16.63c0 3.94-3.19 7.13-7.13 7.13H21.76c-3.94 0-7.13-3.19-7.13-7.13V86.25c.01-3.94 3.2-7.13 7.13-7.13z"
                    fill="#263238"
                    fill-opacity=".2"
                  ></path>
                  <path
                    fill="#fff"
                    fill-opacity=".2"
                    d="M21.76 48.43h76.01c3.94 0 7.13 3.19 7.13 7.13v16.63c0 3.94-3.19 7.13-7.13 7.13H21.76c-3.94 0-7.13-3.19-7.13-7.13V55.56c.01-3.94 3.2-7.13 7.13-7.13z"
                  ></path>
                  <path
                    d="M21.76 51.33h76.01c3.94 0 7.13 2.89 7.13 6.46v43.05c0 3.57-3.19 6.46-7.13 6.46H21.76c-3.94 0-7.13-2.89-7.13-6.46V57.79c.01-3.57 3.2-6.46 7.13-6.46z"
                    fill="#1976d2"
                  ></path>
                  <path
                    fill="#0d47a1"
                    d="M59.77 64.52c-6.84 0-12.64 4.71-14.33 11.05h7.63c1.32-2.34 3.79-3.92 6.7-3.92 4.31 0 7.72 3.41 7.72 7.72s-3.41 7.72-7.72 7.72c-3.11 0-5.73-1.79-6.96-4.39h-7.49c1.53 6.57 7.44 11.52 14.45 11.52 8.16 0 14.85-6.69 14.85-14.85-.01-8.16-6.7-14.85-14.85-14.85z"
                  ></path>
                  <circle
                    cx="59.77"
                    cy="79.37"
                  ...
                  <ellipse
                    ...
                    ry="9.2"
                  ></ellipse>
                  <circle cx="36.9" cy="32.16" r="8.02" fill="#fff"></circle>
                  <ellipse
                    cx="83.22"
                    cy="30.97"
                    fill="#263238"
                    ...
                    ry="9.2"
                  ></ellipse>
                  <circle cx="83.22" cy="32.16" r="8.02" fill="#fff"></circle>
                  <radialGradient
                    id="SVGID_1_"
                    cx="279.1473"
                    cy="119.5198"
                    r="26.9257"
                    gradientTransform="matrix(0 3.9222 3.9556 0 -466.2604 -1090.473)"
                    gradientUnits="userSpaceOnUse"
                  >
                    <stop offset="0" stop-color="#fff" stop-opacity=".098"></stop>
                    <stop offset="1" stop-color="#fff" stop-opacity="0"></stop>
                  </radialGradient>
                  <path
                    fill="url(#SVGID_1_)"
                    d="M8.96 3.92c-1.64-.04-3 1.25-3.05 2.89-.01.7.21 1.38.65 1.93l8.55 11.07c-.3.79-.48 1.65-.48 2.55V38.8c0 3.95 3.18 7.13 7.13 7.13h76.01c3.95 0 7.13-3.18 7.13-7.13V22.35c0-.9-.17-1.76-.47-2.55l8.55-11.07c1.02-1.28.81-3.15-.48-4.17-.49-.39-1.09-.62-1.72-.64-.98-.04-1.91.4-2.5 1.18l-8.14 10.53c-.73-.26-1.53-.41-2.36-.41H21.77c-.83 0-1.63.15-2.37.41L11.27 5.1c-.55-.73-1.39-1.16-2.31-1.18zm12.8 44.7c-3.95 0-7.13 3.18-7.13 7.13v47.13c0 3.95 3.18 7.13 7.13 7.13h76.01c3.95 0 7.13-3.18 7.13-7.13V55.75c.01-3.94-3.17-7.12-7.11-7.12H21.77l-.01-.01z"
                  ></path>
                </svg>
              </a>
            </div>
      ...
      <AccordionItem value="wat-is-diyivi">
        <AccordionTrigger>Wat is DIYivi?</AccordionTrigger>
        <AccordionContent>
          <p>
            DIYivi is een doe-het-zelf tool waarmee je Yivi kunt gebruiken om veilig en eenvoudig
            digitale handtekeningen te zetten en afspraken vast te leggen. Met DIYivi kun je ook
